                ...
                <div className="row">
                    {
                        serviceData.map((data,index)=>(
                            <div key={index} className="col-md-4" >
                                <div style={{display:"flex", alignItems:'center', flexDirection:"column", width:"100%", height:"400px"}} >
                                    ...
                                    <p>{data.description}</p>
                                     <FlatButton title={`₦${JSON.stringify(data.price)}-Get Started`} onClick={()=>console.log('hello')}/>
                                    </div>
